...
/// 우측 메인: 선택 폴더의 썸네일 그리드.
/// 단일 클릭=선택(⌘/⇧로 다중·범위), 더블 클릭=뷰어. 즐겨찾기·별점 오버레이.
...
class _Thumb extends StatefulWidget {
  ...
  const _Thumb({required this.state, required this.item, required this.onOpen});
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.file(
                    File(path),
                    fit: BoxFit.cover,
                    cacheWidth: (state.thumbSize * 2).round(),
