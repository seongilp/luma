      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Row(
              children: [
                MacosIcon(CupertinoIcons.square_arrow_up, size: 20),
                SizedBox(width: 8),
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: MacosTheme.of(ctx).dividerColor),
                    ),
                    child: Row(
                      children: [
                        Expanded(
                        ...
                        const MacosIcon(CupertinoIcons.chevron_right, size: 14, color: Colors.grey),
                      ],
                    ),
                  ),
                ),
